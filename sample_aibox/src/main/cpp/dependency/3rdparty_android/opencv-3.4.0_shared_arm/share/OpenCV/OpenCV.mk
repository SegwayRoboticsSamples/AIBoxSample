...
OPENCV_MODULES:=objdetect stitching superres videostab photo img_hash phase_unwrapping rgbd saliency xfeatures2d calib3d features2d highgui videoio shape imgcodecs video ml imgproc flann core
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    OPENCV_LIBS:=objdetect stitching superres videostab photo img_hash phase_unwrapping rgbd saliency xfeatures2d calib3d features2d highgui videoio shape imgcodecs video ml imgproc flann core
    OPENCV_LIB_TYPE:=SHARED
else
